        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded-full text-sm font-bold border border-emerald-100 dark:border-emerald-800">
            ...
            <Link 
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-linear-to-br from-emerald-600 to-teal-600 text-white font-bold rounded-2xl shadow-xl shadow-emerald-500/20 hover:shadow-2xl hover:-translate-y-1 transition-all"
            >
              Apply to Teach
          ...
          <div className="relative">
            <div className="relative bg-white dark:bg-gray-800 p-8 sm:p-12 rounded-[3rem] border border-gray-100 dark:border-gray-700 shadow-2xl overflow-hidden group">
              {/* Internal Accent */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/5 dark:bg-emerald-500/10 rounded-full -mr-16 -mt-16" />
              ...
              <div className="space-y-10">
                <div className="flex items-center justify-between">
                  ...
                  <div className="px-3 py-1 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 text-xs font-black rounded-full">ESTIMATED</div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <input 
                    ...
                    className="w-full h-3 bg-gray-100 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer accent-emerald-600"
                  />
                </div>
                ...
                <div className="pt-8 border-t border-gray-100 dark:border-gray-700 grid grid-cols-2 gap-4">
                  <div className="p-6 bg-emerald-50 dark:bg-emerald-900/20 rounded-3xl border border-emerald-100 dark:border-emerald-800 text-center">
                    <div className="text-[10px] uppercase font-bold text-emerald-700 dark:text-emerald-500 mb-1">Monthly</div>
